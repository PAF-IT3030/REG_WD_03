...
function FollowButton({ userDetails, fetchType }) {
  ...
  return (
    <>
      {followed ? (
        <button
          className="bg-[#a85e5e] text-white px-2 py-1 rounded min-w-[100px] flex justify-center"
        ...
        <button
          className="bg-[#5ea885] text-white px-2 py-1 rounded min-w-[100px] flex justify-center"
          onClick={handleOnFollow}
        >
          Follow
        </button>
